...
#ifndef SCREENAREASELECTIONVIEW_H
#define SCREENAREASELECTIONVIEW_H
 ...
 */
class ScreenAreaSelectionView : public QWidget
{
    Q_OBJECT

public:

    explicit ScreenAreaSelectionView(QWidget* parent = 0);

    virtual ~ScreenAreaSelectionView();
...
private:
    ...
    Q_DECLARE_PRIVATE(ScreenAreaSelectionView)
    ScreenAreaSelectionViewPrivate *const d_ptr; //!< D-Pointer for this class.
